/* exported String__startsWith */
function String__startsWith(str, prefix) {
...
/* exported String__format */
function String__format(str) {
...
/* exported String__contain */
function String__contain(str, substr) {
...
/* exported String__decodeUrl */
function String__decodeUrl(s) {
...
function String__parseQuery(query) {
    ...
    for (i = 0; i < vars.length; i++) {
        if (vars[i]) {
            pair = vars[i].split('=');
            ret[String__decodeUrl(pair[0])] = String__decodeUrl(pair[1] || '');
        }
    }
...
/* exported String__base64Decode */
function String__base64Decode(str) {
    return decodeURIComponent(escape(atob(str)));
}

/* exported String__base64Encode */
function String__base64Encode(str) {
    return btoa(unescape(encodeURIComponent(str)));
}

var _String__base64EncodeUrlSafeChars = {
    '+': '-',
    '/': '_',
};

function _String__base64EncodeUrlSafeReplace(c) {
    return _String__base64EncodeUrlSafeChars[c];
}

/* exported String__base64EncodeUrlSafe */
function String__base64EncodeUrlSafe(str) {
    return String__base64Encode(str).replace(/[+\/]/g, _String__base64EncodeUrlSafeReplace);
}
